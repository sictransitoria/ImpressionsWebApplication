...
//
// //     ******************   name of database * username * password  *****//
...
// 					return res.render('live-gallery', {user: req.user})
// 				})
// 			}
// 		})(req, res, next);
// })
...
const Op = Sequelize.Op
const sequelize = new Sequelize('userreg', 'postgres', 'Runner4life!', {
	host: 'localhost',
	port: '5432',
	dialect: 'postgres',
	operatorsAliases:{
...
>>>>>>> e66ca21bfe028e1cb93b0524b08b900932147826
